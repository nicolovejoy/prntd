 ...
 * have the two columns the multi-generator branch needs?
 *   - design_image.generator
 *   - design.active_generator_id
 *
 * Prints column presence only — no writes, no secrets.
 *
 *   npx tsx --env-file .env.local scripts/check-multi-generator-schema.ts
 */
