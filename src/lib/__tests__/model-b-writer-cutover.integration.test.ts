 ...
 * source artifacts, `placement_render` for renders, `image_publication`
 * (named `listing` until composition slice 5) for publish state
 * (`design_image` itself was dropped in Model B slice 5). Runs against a real
